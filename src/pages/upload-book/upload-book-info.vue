      ...
      <div class="group">
        ...
        <div class="type-sel">
          ...
          <div class="sel">
            ...
            <img src="https://sunj-share.oss-cn-shenzhen.aliyuncs.com/imgs/type_down.png" alt="" class='img'>
             <picker @change="typeChange" :value="typeIndex" :range="typeList" class='picker'>
        ...
        <div class="title">
          ...
          <img src="https://sunj-share.oss-cn-shenzhen.aliyuncs.com/imgs/home_picture_paintbrush.png" alt="" class='img'>
        </div>
        <div class="text-area-wrapper">
            <textarea  class='text-area' v-model='bookReviewText'  maxlength='100' placeholder='请填写书评' placeholder-style='font-size:15px;color:#6F6F6F;font-family:HYCuYuanJ'></textarea>
  ...
  .group-wrapper{
    ...
    .group{
      ...
      .detail{
        ...
        .book-img{
          .box-size(96px,131px);
          background: url("https://sunj-share.oss-cn-shenzhen.aliyuncs.com/imgs/yellow-book-bg.png") 0 0/100% 100% no-repeat;
          .img{
